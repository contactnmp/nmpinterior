            ...
            <div className="w-full max-w-[1440px] mx-auto mb-30">
                ...
                >
                    ...
                    <motion.h1 
                        ...
                        initial='hidden'
                        whileInView='visible'
                        className="font-serif text-[#021A62] font-semibold text-4xl md:text-[50px] leading-[1.1] mb-5 max-w-[850px]"
                    >
                    ...
                    <motion.p 
                        ...
                        initial='hidden'
                        whileInView='visible'
                        className="font-sans text-[#424346]/80 text-base md:font-medium mb-10 max-w-[600px] leading-relaxed"
                    >
                        {description}
                    </motion.p>
